...
//@interface k1506_UtilityApp_Campbell_KeddonObject : NSObject
//@end

@interface k1506_UtilityApp_Campbell_KeddonObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[k1506_UtilityApp_Campbell_KeddonObject class]])
		{
			for (NSString *key in [[(k1506_UtilityApp_Campbell_KeddonObject*)o modules] allKeys])
			{
