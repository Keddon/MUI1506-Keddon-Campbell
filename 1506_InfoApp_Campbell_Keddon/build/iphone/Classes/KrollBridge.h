...
@interface k1506_InfoApp_Campbell_KeddonObject : KrollCoverageObject {
#else
@interface k1506_InfoApp_Campbell_KeddonObject : KrollObject {
#endif
@private
...
extern NSString * k1506_InfoApp_Campbell_Keddon$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	k1506_InfoApp_Campbell_KeddonObject *_k1506_infoapp_campbell_keddon;
    KrollObject* console;
	BOOL shutdown;
