...
/**
 Base class for all k1506_InfoApp_Campbell_Keddon views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the k1506_InfoApp_Campbell_Keddon view hierarchy (such as wrapped iOS UIViews) was touched.
