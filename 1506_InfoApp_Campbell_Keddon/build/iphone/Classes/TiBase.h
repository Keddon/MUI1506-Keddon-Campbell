...
// in simulator we redefine to format for k1506_InfoApp_Campbell_Keddon Developer console
...
{\
	NSString * exceptionName = [@"org.k1506_infoapp_campbell_keddon." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.k1506_infoapp_campbell_keddon";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIk1506_InfoApp_Campbell_KeddonNativeItemNone = -1, 
	UIk1506_InfoApp_Campbell_KeddonNativeItemSpinner = -2,
	UIk1506_InfoApp_Campbell_KeddonNativeItemProgressBar = -3,
	
	UIk1506_InfoApp_Campbell_KeddonNativeItemSlider = -4,
	UIk1506_InfoApp_Campbell_KeddonNativeItemSwitch = -5,
	UIk1506_InfoApp_Campbell_KeddonNativeItemMultiButton = -6,
	UIk1506_InfoApp_Campbell_KeddonNativeItemSegmented = -7,
	
	UIk1506_InfoApp_Campbell_KeddonNativeItemTextView = -8,
	UIk1506_InfoApp_Campbell_KeddonNativeItemTextField = -9,
	UIk1506_InfoApp_Campbell_KeddonNativeItemSearchBar = -10,
	
	UIk1506_InfoApp_Campbell_KeddonNativeItemPicker = -11,
	UIk1506_InfoApp_Campbell_KeddonNativeItemDatePicker = -12,
	
	UIk1506_InfoApp_Campbell_KeddonNativeItemInfoLight = -13,
	UIk1506_InfoApp_Campbell_KeddonNativeItemInfoDark = -14,
	
	UIk1506_InfoApp_Campbell_KeddonNativeItemDisclosure = -15,
	
	UIk1506_InfoApp_Campbell_KeddonNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all k1506_InfoApp_Campbell_Keddon instances of
